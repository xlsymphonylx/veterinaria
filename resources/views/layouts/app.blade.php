                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-light"
                                href="{{ route('patients.index') }}">{{ __('Pacientes') }}</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-light"
                                href="{{ route('dates.index') }}">{{ __('Citas') }}</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-light"
                                href="{{ route('treatments.index') }}">{{ __('Tratamientos') }}</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-light"
                                href="{{ route('diseases.index') }}">{{ __('Enfermedades') }}</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link fw-bold text-light"
                                href="{{ route('allergies.index') }}">{{ __('Alergias') }}</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto auth-bg__accent">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item auth-bg__accent">
                                    <a class="nav-link fw-bold text-light auth-bg__accent"
                        ...
                        @else
                            <li class="nav-item dropdown auth-bg__accent">
                                ...
                                <div class="dropdown-menu dropdown-menu-end auth-bg__accent" aria-labelledby="navbarDropdown">
